...
var Publish, Receive, async, createhub, cuid, mkdirp, resolve, shulz;
...
createhub = function() {
  return require('odo-hub/hub')(require('odo-hub/dispatch_parallel')());
};

module.exports = function(options) {
  var _, _fin, _ondrained, _onincomingempty, _onoutgoingempty, _removedestination, _subscribe, _unsubscribe, address, addresses, advertise, bind, datadir, envelope, exec, hub, i, incoming, len, outgoing, publisher, rawhub, receiver, ref, ref1, ref2, ref3, replayincoming, replayoutgoing, send, subscriptions;
  _fin = false;
  ...
  return {
    ...
    status: function() {
      return (subscriptions.length()) + " subscribers, " + (incoming.length()) + " incoming and " + (outgoing.length()) + " outgoing";
    },
    close: function() {
      if (_fin) {
        return;
